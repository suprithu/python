...
command = input("please logoff for further verfication  \nto logoff type exi                                                                                        t: ")
if command == "exit":
...
balance = float(input("Enter the amount to be deposited in your account : ")                                                                                        )
...
while command != "q":
        if(command == "b"):
                ...
                amount = float(input("Please enter the amount to be withdraw                                                                                        : "))
